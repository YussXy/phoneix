...
const products = [
    ...
    },
    {
        ...
        desc: "Pilih Layanan Sosial Media",
        productList: [
            { name: "TIKTOK LIKE 100", price: 2000 },
            { name: "TIKTOK FOLLOW 100", price: 5000 },
            { name: "TIKTOK VIEWER 100", price: 1000 },
            { name: "INSTAGRAM LIKE 100", price: 2500 },
            { name: "INSTAGRAM FOLLOW 100", price: 5500 },
            { name: "INSTAGRAM VIEWER 100", price: 15000 }
        ]
    },
    {
        id: 3,
    ...
    },
    {
        ...
        productList: [
            { name: "1 MINGGU", price: 4000 },
            { name: "2 MINGGU", price: 7000 },
            { name: "1 BULAN", price: 13000 },
            { name: "PERMANEN", price: 18000 }
        ]
    },
    {
        id: 5,
        ...
        desc: "Pilih Item Grow A Garden 2",
        productList: [
            { name: "GHOST PAPER", price: 2000 },
            { name: "DRAGON BREATH", price: 3500 },
            { name: "MOON BLOOM", price: 700 },
            { name: "HYPO BLOOM", price: 700 },
            { name: "FIRE FERN", price: 400 },
            { name: "ROKET POP", price: 300 },
            { name: "POISON APPLE", price: 500 },
            { name: "UNICORN", price: 1500 },
            { name: "DRAGON FLY", price: 1000 },
            { name: "BEAR", price: 3000 },
            { name: "RACCOON", price: 29000 },
            { name: "LEGENDARY SPRINKLER", price: 200 },
            { name: "SUPER WATERING CAN", price: 400 },
            { name: "SUPER SPRINKLER", price: 400 },
            { name: "PAKETAN 1 SEED LANGKAH+SUPER", price: 17000 },
            { name: "PAKETAN 2 PET LANGKAH+SUPER", price: 12000 },
            { name: "PAKETAN 3 GEARS LANGKAH+SUPER", price: 8000 },
            { name: "PAKETAN 4 KOMBO TERBAIK LANGKAH+SUPER+GG", price: 60000 }
        ]
    }
];
    ...
    if (product.productList && product.productList.length > 0) {
        ...
        content.innerHTML = `
            <div style="text-align:center; padding: 0 10px;">
                ...
                <div style="font-size:13px; color:#8e95a5; margin-bottom:16px;">Pilih aplikasi yang ingin dibeli:</div>
                <div style="margin:12px 0;">
                    ${listHtml}
                </div>
                <div class="payment-note" style="margin-top:12px;">
                    <i class="ri-alert-line"></i> Pilih salah satu aplikasi di atas untuk lanjut pembayaran
                </div>
                <button class="btn-confirm" style="background:#2a2f38; margin-top:8px;" id="closeListBtn">
